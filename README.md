...
[Marbelis Hugo PORTFOLIO](https://marqaorganization.github.io/portfolioqa/)
...
- **[BUG Report](Errorreaport.pdf)**: Detailed documentation of any defects found during testing, including severity, steps to reproduce, and resolution.
- **[Regression Test Execution Report](Regressiontetsreport.pdf)**: A report outlining the results of regression tests executed at the end of each sprint.
